...
public class Derivative{
	...
	public static class TreeNodeDivide extends TreeNode{
		...
		public TreeNode ComputeDerivative(){
			...
			TreeNode d_right = rightChild.ComputeDerivative();
			//=================================================================================
			return new TreeNodeDivide(
						new TreeNodeSubtract(
							new TreeNodeMultiply(d_left, rightChild), 
							new TreeNodeMultiply(leftChild, d_right)
							), 
						new TreeNodeConstantPower(rightChild, 2)
						);
			//=================================================================================
		}
		public String toString(){
